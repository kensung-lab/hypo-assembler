...
public:
    ...
    inline std::string get_consensus_2() const {return _consensus_2;}
...
private:
    ...
    inline void set_marked_consensus_2(std::string const &con){_consensus_2.assign(con.begin()+cMarkerLen,con.end()-cMarkerLen);}
