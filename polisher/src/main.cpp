...
void decodeFlags(int argc, char *argv[], InputFlags &flags)
{
  ...
  flags.output_filename_1 = "";
  flags.output_filename_2 = "";
                            ...
                            nullptr)) != -1)
  {
    ...
    case 'o':
      flags.output_filename_1 = std::string(optarg) + "_1.fa";
      flags.output_filename_2 = std::string(optarg) + "_2.fa";
  ...
  if (is_sr && is_draft && is_size && is_bamsr && is_cov && is_cov_long && is_lr)
  {
    ...
    if (flags.output_filename_1 == "") {
      ...
      flags.output_filename_1 = "hypo_" + dname + "_1.fa";
      flags.output_filename_2 = "hypo_" + dname + "_2.fa";
    }
